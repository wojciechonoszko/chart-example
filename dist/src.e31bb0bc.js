...
exports.I = throttled;
exports.J = void 0;
exports.K = _isDomSupported;
exports.L = void 0;
exports.M = _factorize;
exports.N = finiteOrDefault;
exports.O = callback;
exports.P = void 0;
exports.Q = _addGrace;
exports.R = toDegrees;
exports.S = _measureText;
exports.T = void 0;
exports.U = _int16Range;
exports.V = _alignPixel;
exports.W = clipArea;
exports.X = renderText;
exports.Y = unclipArea;
exports.Z = toFont;
exports._ = _arrayUnique;
exports.a = resolve;
exports.a$ = _angleDiff;
exports.a1 = exports.a0 = void 0;
exports.a2 = merge;
exports.a3 = _capitalize;
exports.a5 = exports.a4 = void 0;
exports.a6 = _attachContext;
exports.a7 = _createResolver;
exports.a8 = _descriptors;
exports.a9 = mergeIf;
exports.aA = restoreTextDirection;
exports.aB = noop;
exports.aC = distanceBetweenPoints;
exports.aD = _setMinAndMaxByKey;
exports.aE = niceNum;
exports.aF = almostWhole;
exports.aG = almostEquals;
exports.aH = _decimalPlaces;
exports.aI = _longestText;
exports.aJ = _filterBetween;
exports.aK = _lookup;
exports.aL = getHoverColor;
exports.aM = clone$1;
exports.aN = _merger;
exports.aO = _mergerIf;
exports.aP = _deprecated;
exports.aQ = toFontString;
exports.aR = splineCurve;
exports.aS = splineCurveMonotone;
exports.aT = getStyle;
exports.aU = fontString;
exports.aV = toLineHeight;
exports.aa = exports.a_ = exports.aZ = exports.aY = exports.aX = exports.aW = void 0;
exports.ab = debounce;
exports.ac = retinaScale;
exports.ad = clearCanvas;
exports.ae = void 0;
exports.af = _elementsEqual;
exports.ag = _isClickEvent;
exports.ah = _isBetween;
exports.ai = _readValueToProps;
exports.aj = _updateBezierControlPoints;
exports.ak = _computeSegments;
exports.al = _boundSegments;
exports.am = _steppedInterpolation;
exports.an = _bezierInterpolation;
exports.ao = _pointInLine;
exports.ap = _steppedLineTo;
exports.aq = _bezierCurveTo;
exports.ar = drawPoint;
exports.as = addRoundedRectPath;
exports.at = toTRBL;
exports.au = toTRBLCorners;
exports.av = _boundSegment;
exports.aw = _normalizeAngle;
exports.ax = getRtlAdapter;
exports.ay = overrideTextDirection;
exports.az = void 0;
exports.b = isArray;
exports.c = color;
...
exports.$ = _toLeftRightCenter;

const _alignStartEnd = (align, start, end) => align === 'start' ? start : align === 'end' ? end : (start + end) / 2;

exports.a0 = _alignStartEnd;
...
exports.aY = RAD_PER_DEG;
const HALF_PI = PI / 2;
exports.H = HALF_PI;
const QUARTER_PI = PI / 4;
exports.aZ = QUARTER_PI;
const TWO_THIRDS_PI = PI * 2 / 3;
exports.a_ = TWO_THIRDS_PI;
...
exports.a1 = overrides;
const descriptors = Object.create(null);
exports.a4 = descriptors;
...
function getNearestCartesianItems(chart, position, axis, intersect, useFinalPosition) {
  ...
  function evaluationFunc(element, datasetIndex, index) {
    ...
    const pointInArea = (0, _helpersSegment.z)(center, chart.chartArea, chart._minPadding);
...
function _detectPlatform(canvas) {
  if (!(0, _helpersSegment.K)() || typeof OffscreenCanvas !== 'undefined' && canvas instanceof OffscreenCanvas) {
...
const formatters = {
  ...
  numeric(tickValue, index, ticks) {
    ...
    const logDelta = (0, _helpersSegment.L)(Math.abs(delta));
  ...
  logarithmic(tickValue, index, ticks) {
    ...
    const remain = tickValue / Math.pow(10, Math.floor((0, _helpersSegment.L)(tickValue)));
...
function calculateSpacing(majorIndices, ticks, ticksLimit) {
  ...
  const factors = (0, _helpersSegment.M)(evenMajorSpacing);
...
function getTitleHeight(options, fallback) {
  ...
  const font = (0, _helpersSegment.Z)(options.font, fallback);
...
function titleAlign(align, position, reverse) {
  let ret = (0, _helpersSegment.$)(align);
...
function titleArgs(scale, offset, position, align) {
  ...
  if (scale.isHorizontal()) {
    titleX = (0, _helpersSegment.a0)(align, left, right);
    ...
    titleY = (0, _helpersSegment.a0)(align, bottom, top);
...
class Scale extends Element {
  ...
  getUserBounds() {
    ...
    _userMin = (0, _helpersSegment.N)(_userMin, Number.POSITIVE_INFINITY);
    _userMax = (0, _helpersSegment.N)(_userMax, Number.NEGATIVE_INFINITY);
    _suggestedMin = (0, _helpersSegment.N)(_suggestedMin, Number.POSITIVE_INFINITY);
    _suggestedMax = (0, _helpersSegment.N)(_suggestedMax, Number.NEGATIVE_INFINITY);
    return {
      min: (0, _helpersSegment.N)(_userMin, _suggestedMin),
      max: (0, _helpersSegment.N)(_userMax, _suggestedMax),
  ...
  getMinMax(canStack) {
    ...
    return {
      min: (0, _helpersSegment.N)(min, (0, _helpersSegment.N)(max, min)),
      max: (0, _helpersSegment.N)(max, (0, _helpersSegment.N)(min, max))
    };
  }
  ...
  beforeUpdate() {
    (0, _helpersSegment.O)(this.options.beforeUpdate, [this]);
  }
  ...
  update(maxWidth, maxHeight, margins) {
    ...
    if (!this._dataLimitsCached) {
      ...
      this._range = (0, _helpersSegment.Q)(this, grace, beginAtZero);
  ...
  afterUpdate() {
    (0, _helpersSegment.O)(this.options.afterUpdate, [this]);
  }

  beforeSetDimensions() {
    (0, _helpersSegment.O)(this.options.beforeSetDimensions, [this]);
  }
  ...
  afterSetDimensions() {
    (0, _helpersSegment.O)(this.options.afterSetDimensions, [this]);
  }

  _callHooks(name) {
    this.chart.notifyPlugins(name, this.getContext());
    (0, _helpersSegment.O)(this.options[name], [this]);
  }
  ...
  beforeTickToLabelConversion() {
    (0, _helpersSegment.O)(this.options.beforeTickToLabelConversion, [this]);
  }
  ...
  generateTickLabels(ticks) {
    ...
    for (i = 0, ilen = ticks.length; i < ilen; i++) {
      tick = ticks[i];
      tick.label = (0, _helpersSegment.O)(tickOpts.callback, [tick.value, i, ticks], this);
    }
  }

  afterTickToLabelConversion() {
    (0, _helpersSegment.O)(this.options.afterTickToLabelConversion, [this]);
  }

  beforeCalculateLabelRotation() {
    (0, _helpersSegment.O)(this.options.beforeCalculateLabelRotation, [this]);
  }
  ...
  calculateLabelRotation() {
    ...
    if (maxLabelWidth + 6 > tickWidth) {
      ...
      labelRotation = (0, _helpersSegment.R)(Math.min(Math.asin((0, _helpersSegment.w)((labelSizes.highest.height + 6) / tickWidth, -1, 1)), Math.asin((0, _helpersSegment.w)(maxHeight / maxLabelDiagonal, -1, 1)) - Math.asin((0, _helpersSegment.w)(maxLabelHeight / maxLabelDiagonal, -1, 1))));
  ...
  afterCalculateLabelRotation() {
    (0, _helpersSegment.O)(this.options.afterCalculateLabelRotation, [this]);
  }

  beforeFit() {
    (0, _helpersSegment.O)(this.options.beforeFit, [this]);
  }
  ...
  afterFit() {
    (0, _helpersSegment.O)(this.options.afterFit, [this]);
  }
  ...
  _computeLabelSizes(ticks, length) {
    ...
    for (i = 0; i < length; ++i) {
      ...
      if (!(0, _helpersSegment.k)(label) && !(0, _helpersSegment.b)(label)) {
        width = (0, _helpersSegment.S)(ctx, cache.data, cache.gc, width, label);
        height = lineHeight;
        ...
        for (j = 0, jlen = label.length; j < jlen; ++j) {
          ...
          if (!(0, _helpersSegment.k)(nestedLabel) && !(0, _helpersSegment.b)(nestedLabel)) {
            width = (0, _helpersSegment.S)(ctx, cache.data, cache.gc, width, nestedLabel);
            height += lineHeight;
          }
        }
      }
  ...
  getPixelForDecimal(decimal) {
    ...
    return (0, _helpersSegment.U)(this._alignToPixels ? (0, _helpersSegment.V)(this.chart, pixel, 0) : pixel);
  }
  ...
  _computeGridLineItems(chartArea) {
    ...
    const alignBorderValue = function (pixel) {
      return (0, _helpersSegment.V)(chart, pixel, axisWidth);
    };
    ...
    for (i = 0; i < ticksLength; i += step) {
      ...
      alignedLineValue = (0, _helpersSegment.V)(chart, lineValue, lineWidth);
  ...
  drawBorder() {
    ...
    if (this.isHorizontal()) {
      x1 = (0, _helpersSegment.V)(chart, this.left, axisWidth) - axisWidth / 2;
      x2 = (0, _helpersSegment.V)(chart, this.right, lastLineWidth) + lastLineWidth / 2;
      y1 = y2 = borderValue;
    } else {
      y1 = (0, _helpersSegment.V)(chart, this.top, axisWidth) - axisWidth / 2;
      y2 = (0, _helpersSegment.V)(chart, this.bottom, lastLineWidth) + lastLineWidth / 2;
      x1 = x2 = borderValue;
    }
  ...
  drawLabels(chartArea) {
    ...
    for (i = 0, ilen = items.length; i < ilen; ++i) {
      ...
      (0, _helpersSegment.X)(ctx, label, 0, y, tickFont, item);
    }
  ...
  drawTitle() {
    ...
    const font = (0, _helpersSegment.Z)(title.font);
    ...
    (0, _helpersSegment.X)(ctx, title.text, 0, 0, font, {
      color: title.color,
      maxWidth,
      rotation,
  ...
  _resolveTickFontOptions(index) {
    ...
    return (0, _helpersSegment.Z)(opts.font);
  }
...
function registerDefaults(item, scope, parentScope) {
  const itemDefaults = (0, _helpersSegment.a2)(Object.create(null), [parentScope ? _helpersSegment.d.get(parentScope) : {}, _helpersSegment.d.get(scope), item.defaults]);
...
class Registry {
  ...
  _exec(method, registry, component) {
    const camelMethod = (0, _helpersSegment.a3)(method);
    (0, _helpersSegment.O)(component['before' + camelMethod], [], component);
    registry[method](component);
    (0, _helpersSegment.O)(component['after' + camelMethod], [], component);
  }
...
class PluginService {
  ...
  _notify(descriptors, chart, hook, args) {
    ...
    for (const descriptor of descriptors) {
      ...
      if ((0, _helpersSegment.O)(method, params, plugin) === false && args.cancelable) {
        return false;
      }
    }
...
function mergeScaleConfig(config, options) {
  const chartDefaults = _helpersSegment.a1[config.type] || {
    scales: {}
  };
  ...
  Object.keys(configScales).forEach(id => {
    ...
    scales[id] = (0, _helpersSegment.a9)(Object.create(null), [{
      axis
  ...
  config.data.datasets.forEach(dataset => {
    ...
    const datasetDefaults = _helpersSegment.a1[type] || {};
    const defaultScaleOptions = datasetDefaults.scales || {};
    Object.keys(defaultScaleOptions).forEach(defaultID => {
      const axis = getAxisFromDefaultScaleID(defaultID, indexAxis);
      const id = dataset[axis + 'AxisID'] || firstIDs[axis] || axis;
      scales[id] = scales[id] || Object.create(null);
      (0, _helpersSegment.a9)(scales[id], [{
        axis
  ...
  Object.keys(scales).forEach(key => {
    ...
    (0, _helpersSegment.a9)(scale, [_helpersSegment.d.scales[scale.type], _helpersSegment.d.scale]);
  });
  return scales;
}
...
class Config {
  ...
  getOptionScopes(mainScope, keyLists, resetCache) {
    ...
    keyLists.forEach(keys => {
      ...
      keys.forEach(key => addIfFound(scopes, _helpersSegment.a1[type] || {}, key));
      keys.forEach(key => addIfFound(scopes, _helpersSegment.d, key));
      keys.forEach(key => addIfFound(scopes, _helpersSegment.a4, key));
    });
  ...
  chartOptionScopes() {
    ...
    return [options, _helpersSegment.a1[type] || {}, _helpersSegment.d.datasets[type] || {}, {
      type
    }, _helpersSegment.d, _helpersSegment.a4];
  }
  ...
  resolveNamedOptions(scopes, names, context, prefixes = ['']) {
    ...
    if (needContext(resolver, names)) {
      result.$shared = false;
      context = (0, _helpersSegment.a5)(context) ? context() : context;
      const subResolver = this.createResolver(scopes, context, subPrefixes);
      options = (0, _helpersSegment.a6)(resolver, context, subResolver);
    }
  ...
  createResolver(scopes, context, prefixes = [''], descriptorDefaults) {
    ...
    return (0, _helpersSegment.i)(context) ? (0, _helpersSegment.a6)(resolver, context, undefined, descriptorDefaults) : resolver;
  }
...
function getResolver(resolverCache, scopes, prefixes) {
  ...
  if (!cached) {
    const resolver = (0, _helpersSegment.a7)(scopes, prefixes);
    cached = {
      resolver,
...
const hasFunction = value => (0, _helpersSegment.i)(value) && Object.getOwnPropertyNames(value).reduce((acc, key) => acc || (0, _helpersSegment.a5)(value[key]), false);

function needContext(proxy, names) {
  const {
    isScriptable,
    isIndexable
  } = (0, _helpersSegment.a8)(proxy);
  ...
  for (const prop of names) {
    ...
    if (scriptable && ((0, _helpersSegment.a5)(value) || hasFunction(value)) || indexable && (0, _helpersSegment.b)(value)) {
      return true;
    }
  }
...
function onAnimationsComplete(context) {
  ...
  (0, _helpersSegment.O)(animationOptions && animationOptions.onComplete, [context], chart);
}

function onAnimationProgress(context) {
  const chart = context.chart;
  const animationOptions = chart.options.animation;
  (0, _helpersSegment.O)(animationOptions && animationOptions.onProgress, [context], chart);
}

function getCanvas(item) {
  if ((0, _helpersSegment.K)() && typeof item === 'string') {
...
class Chart {
  constructor(item, userConfig) {
    ...
    this.$context = undefined;
    this._doResize = (0, _helpersSegment.ab)(mode => this.update(mode), options.resizeDelay || 0);
    this._dataChanges = [];
  ...
  _initialize() {
    ...
    if (this.options.responsive) {
      ...
      (0, _helpersSegment.ac)(this, this.options.devicePixelRatio);
    }
  ...
  clear() {
    (0, _helpersSegment.ad)(this.canvas, this.ctx);
    return this;
  }
  ...
  _resize(width, height) {
    ...
    if (!(0, _helpersSegment.ac)(this, newRatio, true)) {
      return;
    }
    ...
    (0, _helpersSegment.O)(options.onResize, [this, newSize], this);
  ...
  _resetElements() {
    (0, _helpersSegment.D)(this.data.datasets, (dataset, datasetIndex) => {
  ...
  _updateScales() {
    (0, _helpersSegment.D)(this.scales, scale => {
  ...
  _checkEventBindings() {
    ...
    if (!(0, _helpersSegment.ae)(existingEvents, newEvents) || !!this._responsiveListeners !== options.responsive) {
      this.unbindEvents();
      this.bindEvents();
    }
  }
  ...
  _getUniformDataChanges() {
    ...
    for (let i = 1; i < datasetCount; i++) {
      if (!(0, _helpersSegment.ae)(changeSet, makeSet(i))) {
        return;
      }
    }
  ...
  _updateLayout(minPadding) {
    ...
    this._layers = [];
    (0, _helpersSegment.D)(this.boxes, box => {
  ...
  _updateDatasets(mode) {
    ...
    for (let i = 0, ilen = this.data.datasets.length; i < ilen; ++i) {
      this._updateDataset(i, (0, _helpersSegment.a5)(mode) ? mode({
        datasetIndex: i
      }) : mode);
    }
  ...
  destroy() {
    ...
    if (canvas) {
      this.unbindEvents();
      (0, _helpersSegment.ad)(canvas, ctx);
  ...
  bindUserEvents() {
    ...
    (0, _helpersSegment.D)(this.options.events, type => _add(type, listener));
  }
  ...
  unbindEvents() {
    (0, _helpersSegment.D)(this._listeners, (listener, type) => {
      this.platform.removeEventListener(this, type, listener);
    });
    this._listeners = {};
    (0, _helpersSegment.D)(this._responsiveListeners, (listener, type) => {
      this.platform.removeEventListener(this, type, listener);
    });
    this._responsiveListeners = undefined;
  }
  ...
  setActiveElements(activeElements) {
    ...
    const changed = !(0, _helpersSegment.af)(active, lastActive);
  ...
  _eventHandler(e, replay) {
    const args = {
      ...
      replay,
      cancelable: true,
      inChartArea: (0, _helpersSegment.z)(e, this.chartArea, this._minPadding)
    };
  ...
  _handleEvent(e, replay, inChartArea) {
    ...
    const isClick = (0, _helpersSegment.ag)(e);
    const lastEvent = determineLastEvent(e, this._lastEvent, inChartArea, isClick);

    if (inChartArea) {
      this._lastEvent = null;
      (0, _helpersSegment.O)(options.onHover, [e, active, this], this);

      if (isClick) {
        (0, _helpersSegment.O)(options.onClick, [e, active, this], this);
      }
    }
...
function toRadiusCorners(value) {
  return (0, _helpersSegment.ai)(value, ['outerStart', 'outerEnd', 'innerStart', 'innerEnd']);
}
...
class ArcElement extends Element {
  ...
  inRange(chartX, chartY, useFinalPosition) {
    ...
    const withinRadius = (0, _helpersSegment.ah)(distance, innerRadius + rAdjust, outerRadius + rAdjust);
...
class LineElement extends Element {
  ...
  updateControlPoints(chartArea, indexAxis) {
    ...
    if ((options.tension || options.cubicInterpolationMode === 'monotone') && !options.stepped && !this._pointsUpdated) {
      ...
      (0, _helpersSegment.aj)(this._points, options, chartArea, loop, indexAxis);
  ...
  get segments() {
    return this._segments || (this._segments = (0, _helpersSegment.ak)(this, this.options.segment));
  }
  ...
  interpolate(point, property) {
    ...
    const points = this.points;
    const segments = (0, _helpersSegment.al)(this, {
      property,
      start: value,
      end: value
    });
...
class PointElement extends Element {
  ...
  draw(ctx, area) {
    ...
    ctx.fillStyle = options.backgroundColor;
    (0, _helpersSegment.ar)(ctx, options, this.x, this.y);
  }
...
function parseBorderWidth(bar, maxW, maxH) {
  ...
  const o = (0, _helpersSegment.at)(value);
  return {
...
function inRange(bar, x, y, useFinalPosition) {
  ...
  return bounds && (skipX || (0, _helpersSegment.ah)(x, bounds.left, bounds.right)) && (skipY || (0, _helpersSegment.ah)(y, bounds.top, bounds.bottom));
}
...
class BarElement extends Element {
  ...
  draw(ctx) {
    ...
    const addRectPath = hasRadius(outer.radius) ? _helpersSegment.as : addNormalRectPath;
    ctx.save();
...
function findPoint(line, sourcePoint, property) {
  ...
  for (let i = 0; i < segments.length; i++) {
    ...
    if ((0, _helpersSegment.ah)(pointValue, firstValue, lastValue)) {
...
function getBounds(property, first, last, loop) {
  ...
  if (property === 'angle') {
    start = (0, _helpersSegment.aw)(start);
    end = (0, _helpersSegment.aw)(end);
  }
...
function _segments(line, target, property) {
  ...
  for (const segment of segments) {
    ...
    const targetSegments = (0, _helpersSegment.al)(target, bounds);

    for (const tgt of targetSegments) {
      const subBounds = getBounds(property, tpoints[tgt.start], tpoints[tgt.end], tgt.loop);
      const fillSources = (0, _helpersSegment.av)(segment, points, subBounds);
...
class Legend extends Element {
  ...
  buildLabels() {
    ...
    let legendItems = (0, _helpersSegment.O)(labelOpts.generateLabels, [this.chart], this) || [];
  ...
  fit() {
    ...
    const labelFont = (0, _helpersSegment.Z)(labelOpts.font);
  ...
  adjustHitBoxes() {
    ...
    const rtlHelper = (0, _helpersSegment.ax)(rtl, this.left, this.width);

    if (this.isHorizontal()) {
      let row = 0;
      let left = (0, _helpersSegment.a0)(align, this.left + padding, this.right - this.lineWidths[row]);

      for (const hitbox of hitboxes) {
        if (row !== hitbox.row) {
          row = hitbox.row;
          left = (0, _helpersSegment.a0)(align, this.left + padding, this.right - this.lineWidths[row]);
        }
      ...
      let col = 0;
      let top = (0, _helpersSegment.a0)(align, this.top + titleHeight + padding, this.bottom - this.columnSizes[col].height);

      for (const hitbox of hitboxes) {
        if (hitbox.col !== col) {
          col = hitbox.col;
          top = (0, _helpersSegment.a0)(align, this.top + titleHeight + padding, this.bottom - this.columnSizes[col].height);
        }
  ...
  _draw() {
    ...
    const rtlHelper = (0, _helpersSegment.ax)(opts.rtl, this.left, this.width);
    const labelFont = (0, _helpersSegment.Z)(labelOpts.font);
    const {
      color: fontColor,
      padding
    ...
    const drawLegendBox = function (x, y, legendItem) {
      ...
      if (labelOpts.usePointStyle) {
        ...
        (0, _helpersSegment.ar)(ctx, drawOptions, centerX, centerY);
      } else {
        const yBoxTop = y + Math.max((fontSize - boxHeight) / 2, 0);
        const xBoxLeft = rtlHelper.leftForLtr(x, boxWidth);
        const borderRadius = (0, _helpersSegment.au)(legendItem.borderRadius);
        ctx.beginPath();

        if (Object.values(borderRadius).some(v => v !== 0)) {
          (0, _helpersSegment.as)(ctx, {
            x: xBoxLeft,
            y: yBoxTop,
            w: boxWidth,
            h: boxHeight,
    ...
    const fillText = function (x, y, legendItem) {
      (0, _helpersSegment.X)(ctx, legendItem.text, x, y + itemHeight / 2, labelFont, {
    ...
    if (isHorizontal) {
      cursor = {
        x: (0, _helpersSegment.a0)(align, this.left + padding, this.right - lineWidths[0]),
      ...
      cursor = {
        x: this.left + padding,
        y: (0, _helpersSegment.a0)(align, this.top + titleHeight + padding, this.bottom - columnSizes[0].height),
        line: 0
      };
    }
    ...
    this.legendItems.forEach((legendItem, i) => {
      ...
      if (isHorizontal) {
        if (i > 0 && x + width + padding > this.right) {
          ...
          cursor.line++;
          x = cursor.x = (0, _helpersSegment.a0)(align, this.left + padding, this.right - lineWidths[cursor.line]);
        }
      } else if (i > 0 && y + lineHeight > this.bottom) {
        x = cursor.x = x + columnSizes[cursor.line].width + padding;
        cursor.line++;
        y = cursor.y = (0, _helpersSegment.a0)(align, this.top + titleHeight + padding, this.bottom - columnSizes[cursor.line].height);
      }

      const realX = rtlHelper.x(x);
      drawLegendBox(realX, y, legendItem);
      x = (0, _helpersSegment.az)(textAlign, x + boxWidth + halfFontSize, isHorizontal ? x + width : this.right, opts.rtl);
  ...
  drawTitle() {
    ...
    const titleFont = (0, _helpersSegment.Z)(titleOpts.font);
    ...
    if (this.isHorizontal()) {
      ...
      left = (0, _helpersSegment.a0)(opts.align, left, this.right - maxWidth);
    } else {
      const maxHeight = this.columnSizes.reduce((acc, size) => Math.max(acc, size.height), 0);
      y = topPaddingPlusHalfFontSize + (0, _helpersSegment.a0)(opts.align, this.top, this.bottom - maxHeight - opts.labels.padding - this._computeTitleHeight());
    }

    const x = (0, _helpersSegment.a0)(position, left, left + maxWidth);
    ctx.textAlign = rtlHelper.textAlign((0, _helpersSegment.$)(position));
    ctx.textBaseline = 'middle';
    ctx.strokeStyle = titleOpts.color;
    ctx.fillStyle = titleOpts.color;
    ctx.font = titleFont.string;
    (0, _helpersSegment.X)(ctx, titleOpts.text, x, y, titleFont);
  }
  ...
  _getLegendItemAt(x, y) {
    ...
    if ((0, _helpersSegment.ah)(x, this.left, this.right) && (0, _helpersSegment.ah)(y, this.top, this.bottom)) {
      lh = this.legendHitBoxes;

      for (i = 0; i < lh.length; ++i) {
        hitBox = lh[i];

        if ((0, _helpersSegment.ah)(x, hitBox.left, hitBox.left + hitBox.width) && (0, _helpersSegment.ah)(y, hitBox.top, hitBox.top + hitBox.height)) {
  ...
  handleEvent(e) {
    ...
    if (e.type === 'mousemove') {
      ...
      if (previous && !sameItem) {
        (0, _helpersSegment.O)(opts.onLeave, [e, previous, this], this);
      }

      this._hoveredItem = hoveredItem;

      if (hoveredItem && !sameItem) {
        (0, _helpersSegment.O)(opts.onHover, [e, hoveredItem, this], this);
      }
    } else if (hoveredItem) {
      (0, _helpersSegment.O)(opts.onClick, [e, hoveredItem, this], this);
    }
  }
...
class Title extends Element {
  ...
  update(maxWidth, maxHeight) {
    ...
    this._padding = (0, _helpersSegment.C)(opts.padding);

    const textSize = lineCount * (0, _helpersSegment.Z)(opts.font).lineHeight + this._padding.height;
  ...
  _drawArgs(offset) {
    ...
    if (this.isHorizontal()) {
      ...
      if (options.position === 'left') {
        ...
        titleX = right - offset;
        titleY = (0, _helpersSegment.a0)(align, top, bottom);
        rotation = _helpersSegment.P * 0.5;
      }
  ...
  draw() {
    ...
    const fontOpts = (0, _helpersSegment.Z)(opts.font);
    ...
    (0, _helpersSegment.X)(ctx, opts.text, 0, 0, fontOpts, {
      color: opts.color,
      maxWidth,
      rotation,
      textAlign: (0, _helpersSegment.$)(opts.align),
      textBaseline: 'middle',
      translation: [titleX, titleY]
    });
  }
  ...
  nearest(items, eventPosition) {
    ...
    for (i = 0, len = items.length; i < len; ++i) {
      ...
      if (el && el.hasValue()) {
        ...
        const d = (0, _helpersSegment.aC)(eventPosition, center);
...
function getTooltipSize(tooltip, options) {
  ...
  const bodyFont = (0, _helpersSegment.Z)(options.bodyFont);
  const titleFont = (0, _helpersSegment.Z)(options.titleFont);
  const footerFont = (0, _helpersSegment.Z)(options.footerFont);
...
function getBackgroundPoint(options, size, alignment, chart) {
  ...
  const {
    ...
    bottomLeft,
    bottomRight
  } = (0, _helpersSegment.au)(cornerRadius);
...
class Tooltip extends Element {
  ...
  drawTitle(pt, ctx, options) {
    ...
    if (length) {
      const rtlHelper = (0, _helpersSegment.ax)(options.rtl, this.x, this.width);
      pt.x = getAlignedX(this, options.titleAlign, options);
      ctx.textAlign = rtlHelper.textAlign(options.titleAlign);
      ctx.textBaseline = 'middle';
      titleFont = (0, _helpersSegment.Z)(options.titleFont);
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      const borderRadius = (0, _helpersSegment.au)(labelColors.borderRadius);
  ...
  drawBody(pt, ctx, options) {
    ...
    (0, _helpersSegment.D)(this.beforeBody, fillLineOfText);
    ...
    xLinePadding = 0;
    bodyLineHeight = bodyFont.lineHeight;
    (0, _helpersSegment.D)(this.afterBody, fillLineOfText);
    pt.y -= bodySpacing;
  }
  ...
  drawFooter(pt, ctx, options) {
    ...
    if (length) {
      ...
      ctx.textBaseline = 'middle';
      footerFont = (0, _helpersSegment.Z)(options.footerFont);
  ...
  drawBackground(pt, ctx, tooltipSize, options) {
    ...
    const {
      ...
      bottomLeft,
      bottomRight
    } = (0, _helpersSegment.au)(options.cornerRadius);
    ctx.fillStyle = options.backgroundColor;
    ctx.strokeStyle = options.borderColor;
    ctx.lineWidth = options.borderWidth;
    ctx.beginPath();
  ...
  setActiveElements(activeElements, eventPosition) {
    ...
    const changed = !(0, _helpersSegment.af)(lastActive, active);
  ...
  handleEvent(e, replay, inChartArea = true) {
    ...
    const changed = replay || !(0, _helpersSegment.af)(active, lastActive) || positionChanged;
...
var plugin_tooltip = {
  ...
  defaults: {
    ...
    callbacks: {
      beforeTitle: _helpersSegment.aB,
      ...
      afterTitle: _helpersSegment.aB,
      beforeBody: _helpersSegment.aB,
      beforeLabel: _helpersSegment.aB,
      ...
      afterLabel: _helpersSegment.aB,
      afterBody: _helpersSegment.aB,
      beforeFooter: _helpersSegment.aB,
      footer: _helpersSegment.aB,
      afterFooter: _helpersSegment.aB
    }
  },
  defaultRoutes: {
    bodyFont: 'font',
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  let spacing = (0, _helpersSegment.aE)((rmax - rmin) / maxSpaces / unit) * unit;
  ...
  if (numSpaces > maxSpaces) {
    spacing = (0, _helpersSegment.aE)(numSpaces * spacing / maxSpaces / unit) * unit;
  }
  ...
  if (minDefined && maxDefined && step && (0, _helpersSegment.aF)((max - min) / step, spacing / 1000)) {
    ...
    if ((0, _helpersSegment.aG)(numSpaces, Math.round(numSpaces), spacing / 1000)) {
  ...
  const decimalPlaces = Math.max((0, _helpersSegment.aH)(spacing), (0, _helpersSegment.aH)(niceMin));
  ...
  if (minDefined) {
    if (includeBounds && niceMin !== min) {
      ...
      if ((0, _helpersSegment.aG)(Math.round((niceMin + j * spacing) * factor) / factor, min, relativeLabelSize(min, minSpacing, generationOptions))) {
        j++;
      }
    } else if (niceMin < min) {
      j++;
  ...
  if (maxDefined && includeBounds && niceMax !== max) {
    if (ticks.length && (0, _helpersSegment.aG)(ticks[ticks.length - 1].value, max, relativeLabelSize(max, minSpacing, generationOptions))) {
...
class LinearScaleBase extends Scale {
  ...
  buildTicks() {
    ...
    if (opts.bounds === 'ticks') {
      (0, _helpersSegment.aD)(ticks, this, 'value');
    }
...
function isMajor(tickVal) {
  const remain = tickVal / Math.pow(10, Math.floor((0, _helpersSegment.L)(tickVal)));
  return remain === 1;
}

function generateTicks(generationOptions, dataRange) {
  const endExp = Math.floor((0, _helpersSegment.L)(dataRange.max));
  const endSignificand = Math.ceil(dataRange.max / Math.pow(10, endExp));
  const ticks = [];
  let tickVal = (0, _helpersSegment.N)(generationOptions.min, Math.pow(10, Math.floor((0, _helpersSegment.L)(dataRange.min))));
  let exp = Math.floor((0, _helpersSegment.L)(tickVal));
  ...
  const lastTick = (0, _helpersSegment.N)(generationOptions.max, tickVal);
  ticks.push({
    value: lastTick,
    major: isMajor(tickVal)
  });
...
class LogarithmicScale extends Scale {
  ...
  handleTickRangeOptions() {
    ...
    const exp = (v, m) => Math.pow(10, Math.floor((0, _helpersSegment.L)(v)) + m);
  ...
  configure() {
    ...
    super.configure();
    this._startValue = (0, _helpersSegment.L)(start);
    this._valueRange = (0, _helpersSegment.L)(this.max) - (0, _helpersSegment.L)(start);
  }
  ...
  getPixelForValue(value) {
    ...
    return this.getPixelForDecimal(value === this.min ? 0 : ((0, _helpersSegment.L)(value) - this._startValue) / this._valueRange);
  }
...
function measureLabelSize(ctx, font, label) {
  ...
  return {
    w: (0, _helpersSegment.aI)(ctx, font.string, label),
...
function fitWithPointLabels(scale) {
  ...
  for (let i = 0; i < valueCount; i++) {
    ...
    const plFont = (0, _helpersSegment.Z)(opts.font);
    const textSize = measureLabelSize(scale.ctx, plFont, scale._pointLabels[i]);
    labelSizes[i] = textSize;
    const angleRadians = (0, _helpersSegment.aw)(scale.getIndexAngle(i) + additionalAngle);
    const angle = Math.round((0, _helpersSegment.R)(angleRadians));
...
function buildPointLabelItems(scale, labelSizes, padding) {
  ...
  for (let i = 0; i < valueCount; i++) {
    ...
    const angle = Math.round((0, _helpersSegment.R)((0, _helpersSegment.aw)(pointLabelPosition.angle + _helpersSegment.H)));
...
function drawPointLabels(scale, labelCount) {
  ...
  for (let i = labelCount - 1; i >= 0; i--) {
    ...
    const plFont = (0, _helpersSegment.Z)(optsAtIndex.font);
    const {
      x,
      y,
      textAlign,
    ...
    (0, _helpersSegment.X)(ctx, scale._pointLabels[i], x, y + plFont.lineHeight / 2, plFont, {
...
class RadialLinearScale extends LinearScaleBase {
  ...
  setDimensions() {
    const padding = this._padding = (0, _helpersSegment.C)(getTickBackdropHeight(this.options) / 2);
  ...
  generateTickLabels(ticks) {
    ...
    this._pointLabels = this.getLabels().map((value, index) => {
      const label = (0, _helpersSegment.O)(this.options.pointLabels.callback, [value, index], this);
  ...
  getIndexAngle(index) {
    ...
    return (0, _helpersSegment.aw)(index * angleMultiplier + (0, _helpersSegment.t)(startAngle));
  }
  ...
  drawLabels() {
    ...
    this.ticks.forEach((tick, index) => {
      ...
      const tickFont = (0, _helpersSegment.Z)(optsAtIndex.font);
      ...
      (0, _helpersSegment.X)(ctx, tick.label, 0, -offset, tickFont, {
        color: optsAtIndex.color
      });
    });
    ctx.restore();
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {
      lo,
      hi
    } = (0, _helpersSegment.aK)(timestamps, time);
...
class TimeScale extends Scale {
  ...
  init(scaleOpts, opts) {
    ...
    (0, _helpersSegment.a9)(time.displayFormats, adapter.formats());
    this._parseOpts = {
      parser: time.parser,
      round: time.round,
  ...
  buildTicks() {
    ...
    const min = this.min;
    const max = this.max;
    const ticks = (0, _helpersSegment.aJ)(timestamps, min, max);
  ...
  _tickFormatFunction(time, index, ticks, format) {
    ...
    return formatter ? (0, _helpersSegment.O)(formatter, [label, index, ticks], this) : label;
  }
...
},{"../dist/chart.esm":"../node_modules/chart.js/dist/chart.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
let data = {
  ...
  datasets: [{
    ...
    //wplywa tez na kolor w legendzie
    //ustawienia punktu
    pointStyle: 'rectRot',
    pointRadius: 4,
    pointBorderWidth: 1,
...
let myLineChart = new _auto.default(ctx, {
  type: 'line',
  data: data,
  options: options
}); // =============================================================================================================
...
},{"chart.js/auto":"../node_modules/chart.js/auto/auto.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
